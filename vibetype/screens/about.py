...
class ShowAbout(BaseScreen):
    ...
    def compose_body(self):
        with Vertical(classes='cont'):
                yield Static(
                    "Welcome to VibeType!\n\n"
                    "Here you can type away with themed sentence packs, random words, or your own custom collections. This is an offline, keyboard-first space that's entirely yours.\n\n"
